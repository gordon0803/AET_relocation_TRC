...
for i in range(main_env.num_episodes):
        ...
        while j < main_env.max_epLength:
            ...
            main_env.tick=tick
            a1,a2 = main_env.take_action([s],feature,j,tick) #a1 determines if relocate or not, a2 determines which station to relocate
            ...
            v1=np.reshape(np.array([s, a2, newr, s1,feature,score,featurep,main_env.e,tick,a1]), [1,10])
